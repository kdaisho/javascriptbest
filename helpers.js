...
exports.technologies = ['Vanilla', 'Node', 'React', 'Angular', 'Vue', 'Library', 'Framework', 'Functional Programming', 'Classical Programming', 'TypeScript', 'PWA', 'Template Engine', 'Visualization', 'Machine Learning', 'Game', 'Database', 'Test-Driven', 'Fun', 'Beginner Friedly', 'intermediate', 'Advanced', 'Paid Course'];
