...
exports.technologies = ['Vanilla', 'Node', 'React', 'Angular', 'Vue', 'Library', 'Framework', 'Functional Programming', 'Classical Programming', 'TypeScript', 'PWA', 'Template Engine', 'Graphical/Visualization', 'Database', 'Test-Driven', 'Fun', 'Beginner Friedly', 'intermediate', 'Advanced', 'Paid Course'];
